...
class CSJPLPAlgorithm:
    ...
    def create_bridge(
        ...
        Args:
            ...
            top_k: Ignored (kept for API consistency with RS-JP). CS-JP-LP always returns one globally optimal mapping.
        ...
        # Note: z_star is returned for API consistency but unused. Only x* is needed to extract the join function.
    ...
    def _algorithm_1_round_to_half_integral(
        ...
        for ri in list_r:
            ...
            if all_integral:
                ...
                # Optimization: iterate only over existing PMI scores (sparse dictionary) instead of all O(|R|²|S|²) combinations
